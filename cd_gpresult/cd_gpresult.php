...
$list_fields = array(
                    ...
                    'Version Sysvol'    => 'VERSIONSYSVOL',
                    'Enabled'           => 'ENABLED',
                    'Is Valid'          => 'ISVALID',
                    'Filter Allowed'    => 'FILTERALLOWED',
                    'Access Denied'     => 'ACCESSDENIED',
                    'Som Path'          => 'SOMPATH',
                    'Som Order'         => 'SOMORDER',
                    'Applied Order'     => 'APPLIEDORDER',
...
$sql['SQL']  .= "FROM gpresult WHERE (hardware_id = $systemid)";
